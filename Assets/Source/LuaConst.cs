...
{
    public static string toluaDir = "Assets/ToLua";        //tolua lua文件目录
#if UNITY_EDITOR_WIN
    public static string projectDir = System.IO.Directory.GetParent(Application.dataPath).FullName;
    public static string luaDir = System.IO.Path.Combine(projectDir, "Lua");    //lua根目录
    public static string toluaScriptDir = System.IO.Path.Combine(luaDir, "ToLua");        //tolua lua文件目录
    public static string frameworkDir = System.IO.Path.Combine(luaDir, "Framework");        //tolua lua文件目录
    public static string gameDir = System.IO.Path.Combine(luaDir, "Game");        //tolua lua文件目录
#else
